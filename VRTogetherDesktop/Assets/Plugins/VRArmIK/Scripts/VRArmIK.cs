...
namespace VRArmIK
{
	...
	public class VRArmIK : MonoBehaviour
	{
		...
		Vector3 removeShoulderRightRotation(Vector3 direction) 
		{
		...
		void setUpperArmRotation(Quaternion rotation) 
		{
			arm.upperArm.rotation = rotation * upperArmStartRotation;

		} 
		void setLowerArmRotation(Quaternion rotation) 
		{
			arm.lowerArm.rotation = rotation * lowerArmStartRotation;

		} 
		void setLowerArmLocalRotation(Quaternion rotation)
		{
			arm.lowerArm.rotation = upperArmRotation () * rotation * lowerArmStartRotation;

		} 
		void setWrist1Rotation(Quaternion rotation) 
		{
			arm.wrist1.rotation = rotation * wristStartRotation;

		}
		void setWrist2Rotation(Quaternion rotation) 
		{
			arm.wrist2.rotation = rotation * wristStartRotation;
			
		}

		void setWristLocalRotation(Quaternion rotation) 
		{
			arm.wrist1.rotation = arm.lowerArm.rotation * rotation * wristStartRotation;
