...
public class VRCanvas : MonoBehaviour
{
    ...
    protected virtual void OnTriggerEnter(Collider collider)
    {
        ...
        var pointerCheck = collider.GetComponentInParent<VRUIPointer>();
    ...
    protected virtual void SetupCanvas()
    {
        ...
        var customRaycaster = canvas.gameObject.GetComponent<VRRaycaster>();

        //if it doesn't already exist, add the custom raycaster
        if (!customRaycaster)
        {
            customRaycaster = canvas.gameObject.AddComponent<VRRaycaster>();
        }
