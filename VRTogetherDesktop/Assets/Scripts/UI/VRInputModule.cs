...
public class VRInputModule : PointerInputModule
{
    ...
    {
        /*if (pointer.controller.controller == null)
            return;

        pointer.pointerEventData.scrollDelta = pointer.controller.controller.GetAxis(Valve.VR.EVRButtonId.k_EButton_SteamVR_Touchpad);
